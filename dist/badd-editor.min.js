!function(){var e=angular.module("baddEditor",[]),t=function(e){e.componentsTitle=angular.isDefined(e.componentsTitle)?e.componentsTitle:"Components",e.draggables=[{title:"Container",icon:"fa-square-o",element:'<div class="container"><div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div></div>'},{title:"Row",icon:"fa-align-justify",element:'<div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div>'},{title:"Column",icon:"fa-columns",element:'<div class="col-xs-12"><p>You can make me a smaller column</p></div>'},{title:"Header 1",icon:"fa-header",element:"<h1>An important title</h1>"},{title:"Paragraph",icon:"fa-align-left",element:"<p>Write something useful here</p>"},{title:"Button",icon:"fa-plus-square",element:'<btn class="btn btn-primary">My brand new button</btn>'},{title:"Image",icon:"fa-picture-o",element:'<img src="http://www.avjobs.com/images/v_png_v5/v_collection_png/256x256/shadow/airplane2.png"alt="airplane">'}]};t.$inject=["$scope"];var i=function(){return{restrict:"E",templateUrl:"badd-editor.html",scope:{title:"@",componentsTitle:"@",template:"@"},controller:t}};e.directive("baddEditor",i);var r=function(e,t,i){function r(e,t){var i=e.createElement("link");i.setAttribute("rel","stylesheet"),i.setAttribute("href",t),i.setAttribute("type","text/css"),e.querySelector("head").appendChild(i)}function a(e){if(!_.contains(e.classList,"badd-avoid-dd")){"DIV"===e.tagName&&""!==e.getAttribute("badd-droppable")&&e.setAttribute("badd-droppable",""),""!==e.getAttribute("badd-draggable")&&(e.setAttribute("badd-draggable",""),e.setAttribute("badd-configurable",""));var t=_.toArray(e.querySelectorAll("*"));t.forEach(a)}}function l(){var e=s.document.querySelector("td.badd-editor-components"),t=s.document.querySelector("div.badd-editor-browser-frame");t.style.height=e.getBoundingClientRect().height-1+"px",s.iframe.style.height=e.getBoundingClientRect().height-140+"px";var i=s.document.querySelector("div.badd-editor-browser-address"),r=i.querySelector("div.badd-editor-browser-address-page-title");r.style.width=i.getBoundingClientRect().width-75+"px"}function d(e){s.editableFrameBody.appendChild(e.cloneNode(!0));var t=_.toArray(e.querySelectorAll("*"));t.unshift(e);var r=_.toArray(s.editableFrameBody.querySelectorAll("*"));r.forEach(function(e,r){e.style.cssText=i.getComputedStyle(t[r]).cssText});var a=e.getBoundingClientRect();s.editableFrame.style.top=a.top+"px",s.editableFrame.style.left=a.left+"px",s.editableFrame.style.width=e.offsetWidth+"px",s.editableFrame.style.height=e.offsetHeight+"px",s.editableFrame.style.display="block"}function n(){s.editableFrameBody.innerHTML="",s.editableFrame.style.display="none",s.editableFrame.style.top=0,s.editableFrame.style.left=0,s.editableFrame.style.width=0,s.editableFrame.style.height=0}function o(e){e.stopPropagation(),e.preventDefault(),s.hideSelectedHighlightBorder()}function g(e){s.isIE10?e.designMode="On":e.designMode="on"}var s=this;s.editableTags=["H1","H2","H3","H4","H5","H6","H7","P","B","A","UL","OL","LI"],s.initializeFrame=function(d,n){return function(){s.document=t[0],s.iframe=d[0],l(),i.addEventListener("click",o),s.iframePosition=s.iframe.getBoundingClientRect(),s.iframeDocument=s.iframe.contentDocument,s.iframeDocument.addEventListener("scroll",s.updateHighlightBorderPosition),s.frameHtml=s.iframeDocument.querySelector("html"),s.frameHead=s.iframeDocument.querySelector("head"),s.frameBody=s.iframeDocument.querySelector("body"),s.pageTitle=s.iframeDocument.querySelector("title"),s.pageTitle?n.$apply(function(){n.pageTitle=s.pageTitle.textContent}):s.pageTitle=s.document.createElement("title"),s.transferArea=s.document.createElement("div"),s.transferArea.className="badd-transfer-area",s.frameBody.appendChild(s.transferArea),s.transferArea.innerHTML='<svg class="badd-highlighter badd-avoid-dd"></svg>',s.highlightBorder=s.transferArea.childNodes[0],s.frameBody.appendChild(s.highlightBorder),s.transferArea.innerHTML='<svg class="badd-selected-highlighter badd-avoid-dd"></svg>',s.selectedHighlightBorder=s.transferArea.childNodes[0],s.frameBody.appendChild(s.selectedHighlightBorder),s.transferArea.innerHTML='<iframe class="badd-editable-content-iframe badd-avoid-dd"></iframe>',s.editableFrame=s.transferArea.childNodes[0],s.editableFrame.onload=function(){s.editableFrameDocument=s.editableFrame.contentWindow.document,g(s.editableFrameDocument),s.editableFrameHead=s.editableFrame.contentWindow.document.querySelector("head"),null!=s.editableFrameHead&&(r(s.editableFrameDocument,"badd-editor-editable-frame.min.css"),s.editableFrameBody=s.editableFrame.contentWindow.document.querySelector("body"),s.editableFrameBody.innerHTML="")},s.frameBody.appendChild(s.editableFrame),s.frameHtml.setAttribute("ng-app","baddEditor"),r(s.iframeDocument,"badd-editor-frame.min.css"),s.frameBody.setAttribute("badd-droppable",""),s.frameBody.setAttribute("badd-configurable","");var c=_.toArray(s.frameBody.querySelectorAll("*"));c.forEach(a),s.scope=n,e(s.frameHtml)(n)}},s.changePageTitle=function(e){s.pageTitle.textContent=e},s.startDragging=function(e){e.dataTransfer.setData("text","firefox needs data"),""===e.target.getAttribute("badd-configurable")?(s.previewElement=e.target,s.hideSelectedHighlightBorder()):(s.transferArea.innerHTML=e.target.getAttribute("data-element"),s.previewElement=s.transferArea.querySelector("*"))},s.stopDragging=function(e){s.transferArea.innerHTML="",s.previewElement&&s.previewElement.parentNode&&(s.previewElement.parentNode.removeChild(s.previewElement),s.previewElement=null),s.hideHighlightBorder()},s.elementEntering=function(e){s.previewElement.classList.remove("badd-hidden-preview-element"),e.stopPropagation(),e.preventDefault()},s.elementLeaving=function(e){var t=s.document.elementFromPoint(e.clientX+s.iframePosition.left,e.clientY+s.iframePosition.top);null!=t&&"IFRAME"===t.tagName&&_.contains(t.classList,"badd-editor-browser")||(s.previewElement.classList.add("badd-hidden-preview-element"),s.hideHighlightBorder())},s.elementHovering=function(e){if(e.stopPropagation(),e.preventDefault(),e.target.getAttribute&&e.target!==s.previewElement&&""===e.target.getAttribute("badd-droppable")){var t=_.toArray(e.target.childNodes),i=null,r=null;t.forEach(function(t){if(t.getBoundingClientRect&&!_.contains(e.target.classList,"badd-avoid-dd")&&t!=s.previewElement){var a=t.getBoundingClientRect(),l={X:a.width/2+a.left,Y:a.height/2+a.top},d=l.Y;d-a.top>30&&(d=a.top+30);var n=l.X;n-a.left>30&&(n=a.left+30),e.clientY>d&&e.clientX>n||e.clientY>a.bottom||(null==i?(i=t,r=a):r.left>=a.left&&r.top>=a.top&&(i=t,r=a))}}),i?e.target.insertBefore(s.previewElement,i):e.target.appendChild(s.previewElement),s.showHighlightBorder(e.target)}},s.elementDropped=function(t){t.stopPropagation(),t.preventDefault(),a(s.previewElement),e(s.previewElement)(s.scope),s.previewElement=null},s.updateHighlightBorderPosition=function(){"block"===s.highlightBorder.style.display&&s.lastHoveredTarget&&s.showHighlightBorder(s.lastHoveredTarget)},s.showHighlightBorder=function(e){var t=e.getBoundingClientRect();s.highlightBorder.style.top=t.top-3+"px",s.highlightBorder.style.left=t.left-3+"px",s.highlightBorder.style.width=e.offsetWidth+6+"px",s.highlightBorder.style.height=e.offsetHeight+6+"px",s.highlightBorder.style.display="block",s.lastHoveredTarget=e},s.showSelectedHighlightBorder=function(e){var t=e.getBoundingClientRect();s.selectedHighlightBorder.style.top=t.top-3+"px",s.selectedHighlightBorder.style.left=t.left-3+"px",s.selectedHighlightBorder.style.width=e.offsetWidth+6+"px",s.selectedHighlightBorder.style.height=e.offsetHeight+6+"px",s.selectedHighlightBorder.style.display="block"},s.hideSelectedHighlightBorder=function(){s.selectedHighlightBorder.style.display="none",s.selectedHighlightBorder.style.top=0,s.selectedHighlightBorder.style.left=0,s.selectedHighlightBorder.style.width=0,s.selectedHighlightBorder.style.height=0},s.hideHighlightBorder=function(){s.highlightBorder.style.display="none",s.highlightBorder.style.top=0,s.highlightBorder.style.left=0,s.highlightBorder.style.width=0,s.highlightBorder.style.height=0},s.mouseHovering=function(e){e.stopPropagation(),e.preventDefault(),_.contains(e.target.classList,"badd-avoid-dd")||s.showHighlightBorder(e.target)},s.mouseClick=function(e){if(e.stopPropagation(),e.preventDefault(),e.target!==s.elementBeingEdited&&s.elementBeingEdited){s.elementBeingEdited.addEventListener("dragstart",s.startDragging,!1),s.elementBeingEdited.setAttribute("draggable","true");for(var t=s.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","true"),t=t.parentNode;s.selectedHighlightBorder.classList.remove("badd-edition-mode"),s.elementBeingEdited=null,n()}s.showSelectedHighlightBorder(e.target)},s.mouseDoubleClick=function(e){if(e.stopPropagation(),e.preventDefault(),_.contains(s.editableTags,e.target.tagName)){s.elementBeingEdited=e.target,s.elementBeingEdited.removeEventListener("dragstart",s.startDragging,!1),s.elementBeingEdited.setAttribute("draggable","false");for(var t=s.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","false"),t=t.parentNode;s.selectedHighlightBorder.className+=" badd-edition-mode",d(s.elementBeingEdited)}},s.isIE10=function(){return null!=s.iframe.all},s.mouseLeaving=function(e){e.stopPropagation(),e.preventDefault(),s.hideHighlightBorder()}};r.$inject=["$compile","$document","$window"],e.service("editorService",r)}();
