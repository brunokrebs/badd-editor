!function(){var e=angular.module("baddEditor",[]),t=function(e,t){e.pageTitleChanged=function(){t.changePageTitle(e.pageTitle)},e.componentsTitle=angular.isDefined(e.componentsTitle)?e.componentsTitle:"Components",e.draggables=[{title:"Container",icon:"fa-square-o",element:'<div class="container"><div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div></div>'},{title:"Row",icon:"fa-align-justify",element:'<div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div>'},{title:"Column",icon:"fa-columns",element:'<div class="col-xs-12"><p>You can make me a smaller column</p></div>'},{title:"Header 1",icon:"fa-header",element:"<h1>An important title</h1>"},{title:"Paragraph",icon:"fa-align-left",element:"<p>Write something useful here</p>"},{title:"Button",icon:"fa-plus-square",element:'<button class="btn btn-primary">My brand new button</button>'},{title:"Image",icon:"fa-picture-o",element:'<img src="http://www.avjobs.com/images/v_png_v5/v_collection_png/256x256/shadow/airplane2.png"alt="airplane">'}],e.buttons=[{label:"Arial",tooltip:"Font",icon:"caret"},{label:"11",tooltip:"Font size",icon:"fa fa-caret-down",separate:"btn-separate"},{label:"",tooltip:"Bold",icon:"fa fa-bold",action:t.bold},{label:"",tooltip:"Italic",icon:"fa fa-italic"},{label:"",tooltip:"Underline",icon:"fa fa-underline",separate:"btn-separate"},{label:"F",tooltip:"",icon:"Font color"},{label:"",tooltip:"Background color",icon:"fa fa-square",separate:"btn-separate"},{label:"",tooltip:"Align left",icon:"fa fa-align-left",action:t.alignLeft},{label:"",tooltip:"Align center",icon:"fa fa-align-center",action:t.alignCenter},{label:"",tooltip:"Align right",icon:"fa fa-align-right",action:t.alignRight},{label:"",tooltip:"Justify",icon:"fa fa-align-justify",separate:"btn-separate",action:t.justify},{label:"",tooltip:"Ordered list",icon:"fa fa-list-ol",action:t.orderedList},{label:"",tooltip:"Unordered list",icon:"fa fa-list-ul",action:t.unorderedList}],e.execute=function(e){t.executeAction(e)}};t.$inject=["$scope","editorService"];var i=function(e){return{restrict:"E",templateUrl:"badd-editor.html",scope:{title:"@",componentsTitle:"@",template:"@"},controller:t,link:function(t,i,a){var n=i.find("iframe");n.attr("src",a.template),n.on("load",e.initializeFrame(n,t))}}};i.$inject=["editorService"],e.directive("baddEditor",i);var a=function(e,t,i,a,n){function l(e,t){var i=e.createElement("link");i.setAttribute("rel","stylesheet"),i.setAttribute("href",t),i.setAttribute("type","text/css"),e.querySelector("head").appendChild(i)}var o=this;o.initializeFrame=function(r,c){return function(){o.document=a[0],o.iframe=r[0],t.setup(n),i.setup(n),e.setup(n,t,i),o.iframeDocument=o.iframe.contentDocument,l(o.iframeDocument,"badd-editor-frame.min.css"),o.pageTitle=o.iframeDocument.querySelector("title"),o.pageTitle?c.$apply(function(){c.pageTitle=o.pageTitle.textContent}):o.pageTitle=o.document.createElement("title")}},o.changePageTitle=function(e){o.pageTitle.textContent=e}};a.$inject=["baddDragDropService","baddElementHighlighter","baddElementSelector","$document","$window"],e.service("editorService",a)}();
!function(){var e=angular.module("baddEditor"),i=function(){function e(){n()||(service.iframeDocument.designMode="on",service.iframeDocument.execCommand("StyleWithCSS",!1,!0))}function i(){n()||(service.iframeDocument.designMode="off")}function n(){return null==service.ie11&&(service.ie11=!window.ActiveXObject&&"ActiveXObject"in window),service.ie11}service.editableTags=["H1","H2","H3","H4","H5","H6","H7","P","UL","OL","BUTTON"],service.executeAction=function(n){if(null!=service.lastSelectedElement||null!=service.elementBeingEdited){if(e(),null==service.elementBeingEdited){var c=service.iframeDocument.defaultView.getSelection(),t=service.iframeDocument.createRange();t.setStart(service.lastSelectedElement,0),t.setEnd(service.lastSelectedElement,0),c.removeAllRanges(),c.addRange(t)}n(),i()}},service.alignLeft=function(){service.iframeDocument.execCommand("justifyleft",!1)},service.alignRight=function(){service.iframeDocument.execCommand("justifyright",!1)},service.alignCenter=function(){service.iframeDocument.execCommand("justifyCenter",!1)},service.justify=function(){service.iframeDocument.execCommand("justifyfull",!1)},service.bold=function(){service.iframeDocument.execCommand("bold",!1)},service.orderedList=function(){service.iframeDocument.execCommand("insertOrderedList",!1)},service.unorderedList=function(){service.iframeDocument.execCommand("insertUnorderedList",!1)}};e.service("baddConfigurableService",i)}();
!function(){var e=angular.module("baddEditor"),t=function(){function e(e){e.preventDefault();var t=e.target;if(null!=t.getAttribute("badd-draggble-label"))for(;null==t.getAttribute("badd-draggable");)t=t.parentNode;null!=t.getAttribute("badd-draggable")&&(f.transferArea.innerHTML=t.getAttribute("data-element"),f.previewElement=f.transferArea.childNodes[0],f.previewElement.style.pointerEvents="none",r(e,f.previewElement.tagName))}function t(e){3!=e.which&&(e.preventDefault(),_.contains(p,e.target.tagName)&&(r(e),f.transferArea.appendChild(e.target.cloneNode(!0)),f.previewElement=f.transferArea.childNodes[0],f.previewElement.style.pointerEvents="none",f.lastDraggedElement=e.target))}function n(e){var t="fa fa-question";return _.forEach(c,function(n){n.tagName===e&&(t=n.icon)}),t}function a(e){if(e.preventDefault(),f.previewElement){f.draggableConteiner.innerHTML="",f.draggableIcon=null,f.removeElement=null,f.lastDraggedElement&&e.target!=f.iframeDocument&&(f.lastDraggedElement.style.removeProperty("pointer-events"),f.lastDraggedElement=null);for(var t=e.target;t&&!_.contains(s,t.tagName);)t=t.parentNode;g(t)}}function r(e,t){if(e.target.ownerDocument==f.mainDocument&&(f.baddElementHighlighter.hideHighlightBorder(),f.previewElement&&f.previewElement.parentNode&&f.previewElement.ownerDocument==f.iframeDocument?f.previewElement.parentNode.removeChild(f.previewElement):f.lastDraggedElement&&(f.lastDraggedElement.parentNode.removeChild(f.lastDraggedElement),f.lastDraggedElement=null)),f.draggableIcon||t){t&&!f.draggableIcon&&(f.draggableConteiner.innerHTML='<i class="'+n(t)+'"></i>',f.draggableIcon=f.draggableConteiner.childNodes[0],f.draggableIcon.style.display="block",f.draggableIcon.style.position="fixed",f.draggableIcon.style.fontSize="30px",f.draggableIcon.style.backgroundColor="#2385DC",f.draggableIcon.style.border="1px solid #999",f.draggableIcon.style.color="#fff",f.draggableIcon.style.padding="10px",f.draggableIcon.style.zIndex=16777220);var a=0,r=0;e.target.ownerDocument==f.iframeDocument&&(a=f.iframeLeftOffset,r=f.iframeTopOffset),(e.clientX<0||e.clientY<0)&&(a=f.iframeLeftOffset,r=f.iframeTopOffset),f.draggableIcon.style.left=e.clientX+a+"px",f.draggableIcon.style.top=e.clientY-55+r+"px"}}function l(){f.lastDraggedElement&&f.lastDraggedElement.style.removeProperty("pointer-events"),f.draggableConteiner.innerHTML="",f.draggableIcon=null,f.previewElement&&g(f.lastHoveredDroppable)}function i(e){if(e.target==f.iframeDocument)return f.lastDraggedElement?(f.lastDraggedElement.parentNode.removeChild(f.lastDraggedElement),f.lastDraggedElement=null,f.baddElementHighlighter.hideHighlightBorder()):f.previewElement&&f.previewElement.parentNode&&(f.previewElement.parentNode.removeChild(f.previewElement),f.baddElementHighlighter.hideHighlightBorder()),void r(e);if(null==f.previewElement)f.baddElementHighlighter.showHighlightBorder(e.target);else{if(f.lastDraggedElement&&"none"!=f.lastDraggedElement.style.pointerEvents)return void(f.lastDraggedElement.style.pointerEvents="none");f.baddElementHighlighter.hideHighlightBorder(),f.baddElementSelector.hideSelectedHighlightBorder(),r(e,f.previewElement.tagName),o(e)}}function o(e){for(var t=e.target;!_.contains(s,t.tagName);)t=t.parentNode;if(f.lastDraggedElement){var n=d(e,t);if(t==f.lastDraggedElement.parentNode&&(n==f.lastDraggedElement.nextElementSibling||n==f.lastDraggedElement))return;f.lastDraggedElement.parentNode.removeChild(f.lastDraggedElement),f.lastDraggedElement=null}if(0==m(t))return void(f.lastHoveredDroppable&&t!==f.previewElement&&f.previewElement.parentNode===f.lastHoveredDroppable&&f.lastHoveredDroppable.removeChild(f.previewElement));f.lastHoveredDroppable=t,f.baddElementHighlighter.showHighlightBorder(t);var a=d(e,t);a?t.insertBefore(f.previewElement,a):t.appendChild(f.previewElement)}function d(e,t){var n=_.toArray(t.childNodes),a=null,r=null;return n.forEach(function(t){if(t.getBoundingClientRect&&t!=f.previewElement){var n=t.getBoundingClientRect(),l={X:n.width/2+n.left,Y:n.height/2+n.top},i=l.Y;i-n.top>30&&(i=n.top+30);var o=l.X;o-n.left>30&&(o=n.left+30),e.clientY>i&&e.clientX>o||e.clientY>n.bottom||(null==a?(a=t,r=n):r.left>=n.left&&r.top>=n.top&&(a=t,r=n))}}),a}function g(e){f.lastHoveredDroppable&&0==m(e)&&e!==f.previewElement&&f.previewElement.parentNode===f.lastHoveredDroppable&&f.lastHoveredDroppable.removeChild(f.previewElement),null==e&&(f.lastDraggedElement&&(f.lastDraggedElement.parentNode.removeChild(f.lastDraggedElement),f.lastDraggedElement=null),f.previewElement&&f.previewElement.parentNode&&f.previewElement.parentNode.removeChild(f.previewElement)),f.transferArea.innerHTML="",f.previewElement.style.removeProperty("pointer-events"),f.previewElement=null,f.lastHoveredDroppable=null}function m(e){return e&&e.getAttribute&&f.previewElement&&e!==f.previewElement&&_.contains(s,e.tagName)?void 0:!1}var f=this;f.mainWindow=null,f.baddElementHighlighter=null;var s=["DIV","BODY","P"],p=["DIV","IMG","P","BUTTON","A","H1","H2","H3","H4","H5","H6"],c=[{tagName:"DIV",icon:"fa fa-square-o"},{tagName:"IMG",icon:"fa fa-picture-o"},{tagName:"P",icon:"fa fa-align-left"},{tagName:"BUTTON",icon:"fa fa-plus-square"},{tagName:"A",icon:"fa fa-link"},{tagName:"H1",icon:"fa fa-header"},{tagName:"H2",icon:"fa fa-header"},{tagName:"H3",icon:"fa fa-header"},{tagName:"H4",icon:"fa fa-header"},{tagName:"H5",icon:"fa fa-header"},{tagName:"H6",icon:"fa fa-header"}];f.setup=function(n,o,d){if(null==f.mainWindow){f.baddElementHighlighter=o,f.baddElementSelector=d,f.mainWindow=n,f.mainDocument=f.mainWindow.document,f.mainBody=f.mainDocument.querySelector("body"),f.iframe=f.mainDocument.querySelector("iframe.badd-editor-browser"),f.iframeWindow=f.iframe.contentWindow,f.iframeDocument=f.iframeWindow.document,f.iframeBody=f.iframeDocument.querySelector("body");var g=f.iframe.getBoundingClientRect(),m=n.getComputedStyle(f.iframe);f.iframeLeftOffset=g.left+parseInt(m["padding-left"]),f.iframeTopOffset=g.top+parseInt(m["padding-top"]),f.mainWindow.addEventListener("mousedown",e),f.mainWindow.addEventListener("mouseup",a),f.mainWindow.addEventListener("mousemove",r),f.mainWindow.addEventListener("blur",l),f.iframeWindow.addEventListener("mousedown",t),f.iframeWindow.addEventListener("mouseup",a),f.iframeWindow.addEventListener("mousemove",i),f.draggableConteiner=f.mainDocument.createElement("svg"),f.draggableConteiner.className="badd-draggable-conteiner",f.mainBody.appendChild(f.draggableConteiner),f.transferArea=f.mainDocument.createElement("div"),f.transferArea.className="badd-transfer-area",f.mainBody.appendChild(f.transferArea)}}};e.service("baddDragDropService",t)}();
!function(){var e=angular.module("baddEditor"),i=function(){function e(){"block"===i.highlightBorder.style.display&&i.lastHoveredTarget&&i.showHighlightBorder(i.lastHoveredTarget)}var i=this;i.setup=function(t){null==i.mainWindow&&(i.mainWindow=t,i.mainDocument=i.mainWindow.document,i.iframe=i.mainDocument.querySelector("iframe.badd-editor-browser"),i.iframeWindow=i.iframe.contentWindow,i.iframeDocument=i.iframeWindow.document,i.iframeBody=i.iframeDocument.querySelector("body"),i.highlightBorder=i.iframeDocument.createElement("svg"),i.highlightBorder.className="badd-highlighter",i.iframeBody.appendChild(i.highlightBorder),i.iframeWindow.addEventListener("resize",e),i.iframeDocument.addEventListener("scroll",e))},i.showHighlightBorder=function(e){var t=e.getBoundingClientRect();i.highlightBorder.style.top=t.top-3+"px",i.highlightBorder.style.left=t.left-3+"px",i.highlightBorder.style.width=e.offsetWidth+6+"px",i.highlightBorder.style.height=e.offsetHeight+6+"px",i.highlightBorder.style.display="block",i.lastHoveredTarget=e},i.hideHighlightBorder=function(){i.highlightBorder.style.display="none",i.highlightBorder.style.top=0,i.highlightBorder.style.left=0,i.highlightBorder.style.width=0,i.highlightBorder.style.height=0}};e.service("baddElementHighlighter",i)}();
!function(){var e=angular.module("baddEditor"),t=function(){function e(){l.lastSelectedElement&&l.showSelectedHighlightBorder(l.lastSelectedElement)}function t(e){if(e.preventDefault(),e.target!=l.iframeDocument){if(e.target===l.lastSelectedElement&&null==l.elementBeingEdited)return l.hideSelectedHighlightBorder(),void e.stopPropagation();if(!d(e.target,l.elementBeingEdited)&&l.elementBeingEdited!=e.target){if(e.stopPropagation(),l.elementBeingEdited&&l.elementBeingEdited!==e.target){for(var t=l.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","true"),t=t.parentNode;l.selectedHighlightBorder.setAttribute("class","badd-selected-highlighter badd-avoid-dd"),l.elementBeingEdited.removeAttribute("contentEditable"),l.elementBeingEdited=null}l.showSelectedHighlightBorder(e.target)}}}function i(e){if(e.stopPropagation(),e.target!==l.elementBeingEdited&&!d(e.target,l.elementBeingEdited)&&(e.preventDefault(),_.contains(l.editableTags,e.target.tagName)&&!d(e.target,l.elementBeingEdited))){l.elementBeingEdited=e.target,l.elementBeingEdited.setAttribute("draggable","false");for(var t=l.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","false"),t=t.parentNode;l.hideHighlightBorder(),l.showSelectedHighlightBorder(l.elementBeingEdited),l.selectedHighlightBorder.setAttribute("class","badd-selected-highlighter badd-avoid-dd badd-edition-mode"),l.elementBeingEdited.contentEditable=!0;var i=l.iframe.contentWindow.getSelection();l.iframe.contentWindow.focus(),i.collapse(l.elementBeingEdited,0),l.elementBeingEdited.focus()}}function d(e,t){if(null==e||null==t||e===t)return!1;for(var i=e.parentNode;null!=i;){if(i===t)return!0;i=i.parentNode}return!1}var l=this;l.setup=function(d){null==l.mainWindow&&(l.mainWindow=d,l.mainDocument=l.mainWindow.document,l.iframe=l.mainDocument.querySelector("iframe.badd-editor-browser"),l.iframeWindow=l.iframe.contentWindow,l.iframeDocument=l.iframeWindow.document,l.iframeBody=l.iframeDocument.querySelector("body"),l.selectedHighlightBorder=l.iframeDocument.createElement("svg"),l.selectedHighlightBorder.className="badd-selected-highlighter badd-avoid-dd",l.iframeBody.appendChild(l.selectedHighlightBorder),d.addEventListener("click",l.hideSelectedHighlightBorder),l.iframeWindow.addEventListener("click",t),l.iframeWindow.addEventListener("dblclick",i),l.iframeWindow.addEventListener("resize",e),l.iframeDocument.addEventListener("scroll",e),l.iframeDocument.addEventListener("keyup",e))},l.showSelectedHighlightBorder=function(e){l.lastSelectedElement=e;var t=e.getBoundingClientRect();l.selectedHighlightBorder.style.top=t.top-3+"px",l.selectedHighlightBorder.style.left=t.left-3+"px",l.selectedHighlightBorder.style.width=e.offsetWidth+6+"px",l.selectedHighlightBorder.style.height=e.offsetHeight+6+"px",l.selectedHighlightBorder.style.display="block"},l.hideSelectedHighlightBorder=function(){l.lastSelectedElement=null,l.selectedHighlightBorder.style.display="none",l.selectedHighlightBorder.style.top=0,l.selectedHighlightBorder.style.left=0,l.selectedHighlightBorder.style.width=0,l.selectedHighlightBorder.style.height=0}};e.service("baddElementSelector",t)}();
