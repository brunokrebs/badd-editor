...
!function(){var e=angular.module("baddEditor"),t=function(){function e(e){e.preventDefault();var t=e.target;if(null!=t.getAttribute("badd-draggble-label"))for(;null==t.getAttribute("badd-draggable");)t=t.parentNode;null!=t.getAttribute("badd-draggable")&&(p.transferArea.innerHTML=t.getAttribute("data-element"),p.previewElement=p.transferArea.childNodes[0],p.previewElement.style.pointerEvents="none",r(e,p.previewElement.tagName))}function t(e){3!=e.which&&(e.preventDefault(),_.contains(f,e.target.tagName)&&(r(e),p.transferArea.appendChild(e.target.cloneNode(!0)),p.previewElement=p.transferArea.childNodes[0],p.previewElement.style.pointerEvents="none",p.lastDraggedElement=e.target))}function n(e){var t="fa fa-question";return _.forEach(c,function(n){n.tagName===e&&(t=n.icon)}),t}function a(e){if(e.preventDefault(),p.previewElement){p.draggableConteiner.innerHTML="",p.draggableIcon=null,p.removeElement=null,p.lastDraggedElement&&e.target!=p.iframeDocument&&(p.lastDraggedElement.style.removeProperty("pointer-events"),p.lastDraggedElement=null);for(var t=e.target;t&&!_.contains(s,t.tagName);)t=t.parentNode;g(t)}}function r(e,t){if(e.target.ownerDocument==p.mainDocument&&(p.baddElementHighlighter.hideHighlightBorder(),p.previewElement&&p.previewElement.parentNode&&p.previewElement.ownerDocument==p.iframeDocument?p.previewElement.parentNode.removeChild(p.previewElement):p.lastDraggedElement&&(p.lastDraggedElement.parentNode.removeChild(p.lastDraggedElement),p.lastDraggedElement=null)),p.draggableIcon||t){t&&!p.draggableIcon&&(p.draggableConteiner.innerHTML='<i class="'+n(t)+'"></i>',p.draggableIcon=p.draggableConteiner.childNodes[0],p.draggableIcon.style.display="block",p.draggableIcon.style.position="fixed",p.draggableIcon.style.fontSize="30px",p.draggableIcon.style.backgroundColor="#2385DC",p.draggableIcon.style.border="1px solid #999",p.draggableIcon.style.color="#fff",p.draggableIcon.style.padding="10px",p.draggableIcon.style.zIndex=16777220);var a=0,r=0;e.target.ownerDocument==p.iframeDocument&&(a=p.iframeLeftOffset,r=p.iframeTopOffset),(e.clientX<0||e.clientY<0)&&(a=p.iframeLeftOffset,r=p.iframeTopOffset),p.draggableIcon.style.left=e.clientX+a+"px",p.draggableIcon.style.top=e.clientY-55+r+"px"}}function l(){p.lastDraggedElement&&p.lastDraggedElement.style.removeProperty("pointer-events"),p.draggableConteiner.innerHTML="",p.draggableIcon=null,p.previewElement&&g(p.lastHoveredDroppable)}function i(e){return e.target==p.iframeDocument?(p.lastDraggedElement?(p.lastDraggedElement.parentNode.removeChild(p.lastDraggedElement),p.lastDraggedElement=null,p.baddElementHighlighter.hideHighlightBorder()):p.previewElement&&p.previewElement.parentNode&&(p.previewElement.parentNode.removeChild(p.previewElement),p.baddElementHighlighter.hideHighlightBorder()),void r(e)):void(null==p.previewElement?p.baddElementHighlighter.showHighlightBorder(e.target):(p.lastDraggedElement&&"none"!=p.lastDraggedElement.style.pointerEvents&&(p.lastDraggedElement.style.pointerEvents="none"),p.baddElementHighlighter.hideHighlightBorder(),p.baddElementSelector.hideSelectedHighlightBorder(),r(e,p.previewElement.tagName),o(e)))}function o(e){for(var t=e.target;!_.contains(s,t.tagName);)t=t.parentNode;if(p.lastDraggedElement){var n=d(e,t);if(t==p.lastDraggedElement.parentNode&&(n==p.lastDraggedElement.nextElementSibling||n==p.lastDraggedElement))return;p.lastDraggedElement.parentNode.removeChild(p.lastDraggedElement),p.lastDraggedElement=null}if(0==m(t))return void(p.lastHoveredDroppable&&t!==p.previewElement&&p.previewElement.parentNode===p.lastHoveredDroppable&&p.lastHoveredDroppable.removeChild(p.previewElement));p.lastHoveredDroppable=t,p.baddElementHighlighter.showHighlightBorder(t);var a=d(e,t);a?t.insertBefore(p.previewElement,a):t.appendChild(p.previewElement)}function d(e,t){var n=_.toArray(t.childNodes),a=null,r=null;return n.forEach(function(t){if(t.getBoundingClientRect&&t!=p.previewElement){var n=t.getBoundingClientRect(),l={X:n.width/2+n.left,Y:n.height/2+n.top},i=l.Y;i-n.top>30&&(i=n.top+30);var o=l.X;o-n.left>30&&(o=n.left+30),e.clientY>i&&e.clientX>o||e.clientY>n.bottom||(null==a?(a=t,r=n):r.left>=n.left&&r.top>=n.top&&(a=t,r=n))}}),a}function g(e){p.lastHoveredDroppable&&0==m(e)&&e!==p.previewElement&&p.previewElement.parentNode===p.lastHoveredDroppable&&p.lastHoveredDroppable.removeChild(p.previewElement),null==e&&(p.lastDraggedElement&&(p.lastDraggedElement.parentNode.removeChild(p.lastDraggedElement),p.lastDraggedElement=null),p.previewElement&&p.previewElement.parentNode&&p.previewElement.parentNode.removeChild(p.previewElement)),p.transferArea.innerHTML="",p.previewElement.style.removeProperty("pointer-events"),p.previewElement=null,p.lastHoveredDroppable=null}function m(e){return e&&e.getAttribute&&p.previewElement&&e!==p.previewElement&&_.contains(s,e.tagName)?void 0:!1}var p=this;p.mainWindow=null,p.baddElementHighlighter=null;var s=["DIV","BODY","P"],f=["DIV","IMG","P","BUTTON","A","H1","H2","H3","H4","H5","H6"],c=[{tagName:"DIV",icon:"fa fa-square-o"},{tagName:"IMG",icon:"fa fa-picture-o"},{tagName:"P",icon:"fa fa-align-left"},{tagName:"BUTTON",icon:"fa fa-plus-square"},{tagName:"A",icon:"fa fa-link"},{tagName:"H1",icon:"fa fa-header"},{tagName:"H2",icon:"fa fa-header"},{tagName:"H3",icon:"fa fa-header"},{tagName:"H4",icon:"fa fa-header"},{tagName:"H5",icon:"fa fa-header"},{tagName:"H6",icon:"fa fa-header"}];p.setup=function(n,o,d){if(null==p.mainWindow){p.baddElementHighlighter=o,p.baddElementSelector=d,p.mainWindow=n,p.mainDocument=p.mainWindow.document,p.mainBody=p.mainDocument.querySelector("body"),p.iframe=p.mainDocument.querySelector("iframe.badd-editor-browser"),p.iframeWindow=p.iframe.contentWindow,p.iframeDocument=p.iframeWindow.document,p.iframeBody=p.iframeDocument.querySelector("body");var g=p.iframe.getBoundingClientRect(),m=n.getComputedStyle(p.iframe);p.iframeLeftOffset=g.left+parseInt(m["padding-left"]),p.iframeTopOffset=g.top+parseInt(m["padding-top"]),p.mainWindow.addEventListener("mousedown",e),p.mainWindow.addEventListener("mouseup",a),p.mainWindow.addEventListener("mousemove",r),p.mainWindow.addEventListener("blur",l),p.iframeWindow.addEventListener("mousedown",t),p.iframeWindow.addEventListener("mouseup",a),p.iframeWindow.addEventListener("mousemove",i),p.draggableConteiner=p.mainDocument.createElement("svg"),p.draggableConteiner.className="badd-draggable-conteiner",p.mainBody.appendChild(p.draggableConteiner),p.transferArea=p.mainDocument.createElement("div"),p.transferArea.className="badd-transfer-area",p.mainBody.appendChild(p.transferArea)}}};e.service("baddDragDropService",t)}();
