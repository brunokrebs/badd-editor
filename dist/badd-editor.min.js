!function(){var e=angular.module("baddEditor",[]),t=function(e){e.componentsTitle=angular.isDefined(e.componentsTitle)?e.componentsTitle:"Components",e.draggables=[{title:"Container",icon:"fa-square-o",element:'<div class="container"><div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div></div>'},{title:"Row",icon:"fa-align-justify",element:'<div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div>'},{title:"Column",icon:"fa-columns",element:'<div class="col-xs-12"><p>You can make me a smaller column</p></div>'},{title:"Header 1",icon:"fa-header",element:"<h1>An important title</h1>"},{title:"Paragraph",icon:"fa-align-left",element:"<p>Write something useful here</p>"},{title:"Button",icon:"fa-plus-square",element:'<btn class="btn btn-primary">My brand new button</btn>'},{title:"Image",icon:"fa-picture-o",element:'<img src="http://www.avjobs.com/images/v_png_v5/v_collection_png/256x256/shadow/airplane2.png"alt="airplane">'}]};t.$inject=["$scope"];var i=function(){return{restrict:"E",templateUrl:"badd-editor.html",scope:{title:"@",componentsTitle:"@",template:"@"},controller:t}};e.directive("baddEditor",i);var r=function(e,t,i){function r(e,t){var i=e.createElement("link");i.setAttribute("rel","stylesheet"),i.setAttribute("href",t),i.setAttribute("type","text/css"),e.querySelector("head").appendChild(i)}function a(e){if(!_.contains(e.classList,"badd-avoid-dd")){"DIV"===e.tagName&&""!==e.getAttribute("badd-droppable")&&e.setAttribute("badd-droppable",""),""!==e.getAttribute("badd-draggable")&&(e.setAttribute("badd-draggable",""),e.setAttribute("badd-configurable",""));var t=_.toArray(e.querySelectorAll("*"));t.forEach(a)}}function l(){var e=c.document.querySelector("td.badd-editor-components"),t=c.document.querySelector("div.badd-editor-browser-frame");t.style.height=e.getBoundingClientRect().height-1+"px",c.iframe.style.height=e.getBoundingClientRect().height-140+"px";var i=c.document.querySelector("div.badd-editor-browser-address"),r=i.querySelector("div.badd-editor-browser-address-page-title");r.style.width=i.getBoundingClientRect().width-75+"px"}function d(e){c.editableFrameBody.appendChild(e.cloneNode(!0)),c.editableFrameStyle.innerHTML+="body>"+e.tagName.toLowerCase()+"{margin:0 !important}";var t=_.toArray(e.querySelectorAll("*"));t.unshift(e);var i=_.toArray(c.editableFrameBody.querySelectorAll("*"));i.forEach(function(e,i){var r="badd-random-class-"+(new Date).getTime()+i;e.classList.add(r),c.editableFrameStyle.innerHTML+=" ."+r+n(t[i]),e.style.cssText=t[i].cssText});var r=e.getBoundingClientRect();c.editableFrame.style.top=r.top+"px",c.editableFrame.style.left=r.left+"px",c.editableFrame.style.width=e.offsetWidth+"px",c.editableFrame.style.height=e.offsetHeight+"px",c.editableFrame.style.display="block",e.style.opacity="0",c.editableFrame.contentWindow.focus(),c.editableFrameBody.firstElementChild.focus();var a=c.editableFrame.contentWindow.getSelection();c.editableFrame.contentWindow.focus(),c.editableFrameBody.firstElementChild.focus(),a.collapse(c.editableFrameBody.firstElementChild,0)}function n(e){for(var t="",r=i.getComputedStyle(e),a=["height","margin","margin-bottom","margin-left","margin-right","margin-top","max-height","min-height","min-width","width"],l=0;l<r.length;l++){var d=r[l];_.contains(a,d)||"-"==d.substring(0,1)||(t+=r[l]+":"+r.getPropertyValue(r[l])+";")}return"{"+t+"}"}function o(){c.editableFrameStyle.innerHTML="html,body{overflow:hidden;margin:0}",c.editableFrameBody.innerHTML="",c.editableFrameBody.firstChild&&c.editableFrameBody.removeChild(c.editableFrameBody.firstChild),c.editableFrame.style.display="none",c.editableFrame.style.top=0,c.editableFrame.style.left=0,c.editableFrame.style.width=0,c.editableFrame.style.height=0}function s(e){e.stopPropagation(),e.preventDefault(),c.hideSelectedHighlightBorder()}function g(e){c.isIE10?e.designMode="On":e.designMode="on"}var c=this;c.editableTags=["H1","H2","H3","H4","H5","H6","H7","P","B","A","UL","OL","LI"],c.initializeFrame=function(d,n){return function(){c.document=t[0],c.iframe=d[0],l(),i.addEventListener("click",s),c.iframePosition=c.iframe.getBoundingClientRect(),c.iframeDocument=c.iframe.contentDocument,c.iframeDocument.addEventListener("scroll",c.updateHighlightBorderPosition),c.frameHtml=c.iframeDocument.querySelector("html"),c.frameHead=c.iframeDocument.querySelector("head"),c.frameBody=c.iframeDocument.querySelector("body"),c.pageTitle=c.iframeDocument.querySelector("title"),c.pageTitle?n.$apply(function(){n.pageTitle=c.pageTitle.textContent}):c.pageTitle=c.document.createElement("title"),c.transferArea=c.document.createElement("div"),c.transferArea.className="badd-transfer-area",c.frameBody.appendChild(c.transferArea),c.transferArea.innerHTML='<svg class="badd-highlighter badd-avoid-dd"></svg>',c.highlightBorder=c.transferArea.childNodes[0],c.frameBody.appendChild(c.highlightBorder),c.transferArea.innerHTML='<svg class="badd-selected-highlighter badd-avoid-dd"></svg>',c.selectedHighlightBorder=c.transferArea.childNodes[0],c.frameBody.appendChild(c.selectedHighlightBorder),c.transferArea.innerHTML='<iframe class="badd-editable-content-iframe badd-avoid-dd"></iframe>',c.editableFrame=c.transferArea.childNodes[0],c.editableFrame.onload=function(){c.editableFrameDocument=c.editableFrame.contentWindow.document,g(c.editableFrameDocument),c.editableFrameHead=c.editableFrame.contentWindow.document.querySelector("head"),null!=c.editableFrameHead&&(c.editableFrameStyle=c.editableFrameDocument.createElement("style"),c.editableFrameStyle.innerHTML="html,body{overflow:hidden;margin:0}",c.editableFrameHead.appendChild(c.editableFrameStyle),c.editableFrameBody=c.editableFrame.contentWindow.document.querySelector("body"),c.editableFrameBody.innerHTML="")},c.frameBody.appendChild(c.editableFrame),c.frameHtml.setAttribute("ng-app","baddEditor"),r(c.iframeDocument,"badd-editor-frame.min.css"),c.frameBody.setAttribute("badd-droppable",""),c.frameBody.setAttribute("badd-configurable","");var o=_.toArray(c.frameBody.querySelectorAll("*"));o.forEach(a),c.scope=n,e(c.frameHtml)(n)}},c.changePageTitle=function(e){c.pageTitle.textContent=e},c.startDragging=function(e){e.dataTransfer.setData("text","firefox needs data"),""===e.target.getAttribute("badd-configurable")?(c.previewElement=e.target,c.hideSelectedHighlightBorder()):(c.transferArea.innerHTML=e.target.getAttribute("data-element"),c.previewElement=c.transferArea.querySelector("*"))},c.stopDragging=function(e){c.transferArea.innerHTML="",c.previewElement&&c.previewElement.parentNode&&(c.previewElement.parentNode.removeChild(c.previewElement),c.previewElement=null),c.hideHighlightBorder()},c.elementEntering=function(e){c.previewElement.classList.remove("badd-hidden-preview-element"),e.stopPropagation(),e.preventDefault()},c.elementLeaving=function(e){var t=c.document.elementFromPoint(e.clientX+c.iframePosition.left,e.clientY+c.iframePosition.top);null!=t&&"IFRAME"===t.tagName&&_.contains(t.classList,"badd-editor-browser")||(c.previewElement.classList.add("badd-hidden-preview-element"),c.hideHighlightBorder())},c.elementHovering=function(e){if(e.stopPropagation(),e.preventDefault(),e.target.getAttribute&&e.target!==c.previewElement&&""===e.target.getAttribute("badd-droppable")){var t=_.toArray(e.target.childNodes),i=null,r=null;t.forEach(function(t){if(t.getBoundingClientRect&&!_.contains(e.target.classList,"badd-avoid-dd")&&t!=c.previewElement){var a=t.getBoundingClientRect(),l={X:a.width/2+a.left,Y:a.height/2+a.top},d=l.Y;d-a.top>30&&(d=a.top+30);var n=l.X;n-a.left>30&&(n=a.left+30),e.clientY>d&&e.clientX>n||e.clientY>a.bottom||(null==i?(i=t,r=a):r.left>=a.left&&r.top>=a.top&&(i=t,r=a))}}),i?e.target.insertBefore(c.previewElement,i):e.target.appendChild(c.previewElement),c.showHighlightBorder(e.target)}},c.elementDropped=function(t){t.stopPropagation(),t.preventDefault(),a(c.previewElement),e(c.previewElement)(c.scope),c.previewElement=null},c.updateHighlightBorderPosition=function(){"block"===c.highlightBorder.style.display&&c.lastHoveredTarget&&c.showHighlightBorder(c.lastHoveredTarget)},c.showHighlightBorder=function(e){var t=e.getBoundingClientRect();c.highlightBorder.style.top=t.top-3+"px",c.highlightBorder.style.left=t.left-3+"px",c.highlightBorder.style.width=e.offsetWidth+6+"px",c.highlightBorder.style.height=e.offsetHeight+6+"px",c.highlightBorder.style.display="block",c.lastHoveredTarget=e},c.showSelectedHighlightBorder=function(e){var t=e.getBoundingClientRect();c.selectedHighlightBorder.style.top=t.top-3+"px",c.selectedHighlightBorder.style.left=t.left-3+"px",c.selectedHighlightBorder.style.width=e.offsetWidth+6+"px",c.selectedHighlightBorder.style.height=e.offsetHeight+6+"px",c.selectedHighlightBorder.style.display="block"},c.hideSelectedHighlightBorder=function(){c.selectedHighlightBorder.style.display="none",c.selectedHighlightBorder.style.top=0,c.selectedHighlightBorder.style.left=0,c.selectedHighlightBorder.style.width=0,c.selectedHighlightBorder.style.height=0},c.hideHighlightBorder=function(){c.highlightBorder.style.display="none",c.highlightBorder.style.top=0,c.highlightBorder.style.left=0,c.highlightBorder.style.width=0,c.highlightBorder.style.height=0},c.mouseHovering=function(e){e.stopPropagation(),e.preventDefault(),_.contains(e.target.classList,"badd-avoid-dd")||c.showHighlightBorder(e.target)},c.mouseClick=function(e){if(e.stopPropagation(),e.preventDefault(),e.target!==c.elementBeingEdited&&c.elementBeingEdited){c.elementBeingEdited.addEventListener("dragstart",c.startDragging,!1),c.elementBeingEdited.setAttribute("draggable","true");for(var t=c.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","true"),t=t.parentNode;var i=c.editableFrameBody.querySelectorAll("*");_.forEach(i,function(e){var t=e.classList;_.forEach(t,function(t){t.indexOf("badd-random-class")>=0&&e.classList.remove(t)}),0==e.classList.length&&e.removeAttribute("class")}),c.selectedHighlightBorder.setAttribute("class","badd-selected-highlighter badd-avoid-dd"),c.transferArea.innerHTML=c.editableFrameBody.innerHTML,c.elementBeingEdited.parentNode.replaceChild(c.transferArea.childNodes[0],c.elementBeingEdited),c.elementBeingEdited=null,o()}c.showSelectedHighlightBorder(e.target)},c.mouseDoubleClick=function(e){if(e.stopPropagation(),e.preventDefault(),_.contains(c.editableTags,e.target.tagName)){c.elementBeingEdited=e.target,c.elementBeingEdited.removeEventListener("dragstart",c.startDragging,!1),c.elementBeingEdited.setAttribute("draggable","false");for(var t=c.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","false"),t=t.parentNode;c.selectedHighlightBorder.setAttribute("class",c.selectedHighlightBorder.className.baseVal+" badd-edition-mode"),d(c.elementBeingEdited)}},c.isIE10=function(){return null!=c.iframe.all},c.mouseLeaving=function(e){e.stopPropagation(),e.preventDefault(),c.hideHighlightBorder()}};r.$inject=["$compile","$document","$window"],e.service("editorService",r)}();
