...
!function(){var e=angular.module("baddEditor"),r=function(){return{restrict:"A",link:function(e,r){var t=$("iframe.badd-editor-browser").offset();t.left=t.left+62,t.top=t.top+22,r.draggable({revert:!1,helper:"clone",iframeFix:!0,refreshPositions:!0,cursorAt:t,drag:function(){$(this).addClass("drag-active"),$(this).closest(r).addClass("drag-active")},stop:function(e,t){$(this).removeClass("drag-active").closest(r).removeClass("drag-active")}})}}};e.directive("baddDraggable",r)}();
...
!function(){var e=angular.module("baddEditor"),t=function(e,t){function r(e){e.each(function(){return $(this).hasClass(d.entered)?void i($(this)):void 0})}function i(e){e.removeClass(d.entered),d.entered=null;var t=e.parents("body");t.find(".badd-highlighter").remove(),d.objectPreview&&d.objectPreview.remove()}function o(e){if(!(0>e)){var t=null,r=1e7,o=0;d.droppableTarget.children().each(function(){e<=$(this).offset().top&&$(this).offset().top<r&&(t=$(this),r=$(this).offset().top),e>$(this).offset().top&&!$(this).is(d.objectPreview)&&o++}),d.verticalOrdering!==o&&(i(d.droppableTarget),d.objectPreview=$(d.droppableObject.draggable.data("raw")),t?d.objectPreview.insertBefore(t):d.droppableTarget.append(d.objectPreview),d.verticalOrdering=o)}}function a(){d.mouseListenerRegistered||(n(),$("html").mousemove(function(e){if(d.droppableTarget&&d.droppableObject){o(e.pageY-d.iframeOffsetY);var t=d.droppableTarget.offset(),r=d.droppableTarget.outerWidth(),i=d.droppableTarget.outerHeight(),a=d.droppableTarget.parents("body");a.append('<div class="badd-highlighter" style="position: fixed; top: '+t.top+"px ; left: "+t.left+"px ; width: "+r+"px; height: "+i+'px; border: 2px dashed lightskyblue;" />')}}),d.mouseListenerRegistered=!0)}function n(){var e=$("html").find("iframe.badd-editor-browser");d.iframeOffsetY=e.offset().top}var d=this;return d.entered=null,d.mouseListenerRegistered=!1,d.iframeOffsetY=null,d.droppableObject=null,d.droppableTarget=null,d.verticalOrdering=0,d.objectEntering=function(e,i){a(),r($(this).parents()),d.entered||(d.entered=t.getNextUniqueClass(),$(this).addClass(d.entered),d.droppableObject=i,d.droppableTarget=$(this))},d.objectLeaving=function(){d.entered&&$(this).hasClass(d.entered)&&(d.droppableTarget=null,d.verticalOrdering=null,i($(this)))},d.objectDropped=function(t){return function(r){e(objectPreview)(t),d.objectPreview=null,d.droppableObject=null,d.droppableTarget=null,d.objectLeaving(r)}},{restrict:"A",link:function(e,t){t.droppable({activeClass:"drop-active",greedy:!0,hoverClass:"drop-hover",iframeFix:!0,tolerance:"intersect",over:d.objectEntering,out:d.objectLeaving,drop:d.objectDropped(e)})}}};t.$inject=["$compile","editorService"],e.directive("baddDroppable",t)}();
