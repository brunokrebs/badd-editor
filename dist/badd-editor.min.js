!function(){var e=angular.module("baddEditor",[]),t=function(e,t){e.pageTitleChanged=function(){t.changePageTitle(e.pageTitle)},e.componentsTitle=angular.isDefined(e.componentsTitle)?e.componentsTitle:"Components",e.draggables=[{title:"Container",icon:"fa-square-o",element:'<div class="container"><div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div></div>'},{title:"Row",icon:"fa-align-justify",element:'<div class="row"><div class="col-xs-12"><p>A simple row with a single column</p></div></div>'},{title:"Column",icon:"fa-columns",element:'<div class="col-xs-12"><p>You can make me a smaller column</p></div>'},{title:"Header 1",icon:"fa-header",element:"<h1>An important title</h1>"},{title:"Paragraph",icon:"fa-align-left",element:"<p>Write something useful here</p>"},{title:"Button",icon:"fa-plus-square",element:'<btn class="btn btn-primary">My brand new button</btn>'},{title:"Image",icon:"fa-picture-o",element:'<img src="http://www.avjobs.com/images/v_png_v5/v_collection_png/256x256/shadow/airplane2.png"alt="airplane">'}]};t.$inject=["$scope","editorService"];var i=function(e){return{restrict:"E",templateUrl:"badd-editor.html",scope:{title:"@",componentsTitle:"@",template:"@"},controller:t,link:function(t,i,r){var l=i.find("iframe");l.attr("src",r.template),l.on("load",e.initializeFrame(l,t))}}};i.$inject=["editorService"],e.directive("baddEditor",i);var r=function(e,t,i){function r(e,t){var i=e.createElement("link");i.setAttribute("rel","stylesheet"),i.setAttribute("href",t),i.setAttribute("type","text/css"),e.querySelector("head").appendChild(i)}function l(e){if(!_.contains(e.classList,"badd-avoid-dd")){"DIV"===e.tagName&&""!==e.getAttribute("badd-droppable")&&e.setAttribute("badd-droppable",""),""!==e.getAttribute("badd-draggable")&&(e.setAttribute("badd-draggable",""),e.setAttribute("badd-configurable",""));var t=_.toArray(e.querySelectorAll("*"));t.forEach(l)}}function n(e){e.stopPropagation(),e.preventDefault(),d.hideSelectedHighlightBorder()}function a(e,t){if(null==e||null==t||e===t)return!1;for(var i=e.parentNode;null!=i;){if(i===t)return!0;i=i.parentNode}return!1}var d=this;d.editableTags=["H1","H2","H3","H4","H5","H6","H7","P","B","A","UL","OL","LI","BTN"],d.initializeFrame=function(a,o){return function(){d.document=t[0],d.iframe=a[0],i.addEventListener("click",n),d.iframePosition=d.iframe.getBoundingClientRect(),d.iframeDocument=d.iframe.contentDocument,d.iframeDocument.addEventListener("keyup",function(){d.hideHighlightBorder(),d.updateSelectedHighlightBorderPosition()}),d.iframeDocument.addEventListener("scroll",function(){d.updateHighlightBorderPosition(),d.updateSelectedHighlightBorderPosition()}),d.frameHtml=d.iframeDocument.querySelector("html"),d.frameHead=d.iframeDocument.querySelector("head"),d.frameBody=d.iframeDocument.querySelector("body"),d.pageTitle=d.iframeDocument.querySelector("title"),d.pageTitle?o.$apply(function(){o.pageTitle=d.pageTitle.textContent}):d.pageTitle=d.document.createElement("title"),d.transferArea=d.document.createElement("div"),d.transferArea.className="badd-transfer-area",d.frameBody.appendChild(d.transferArea),d.transferArea.innerHTML='<svg class="badd-highlighter badd-avoid-dd"></svg>',d.highlightBorder=d.transferArea.childNodes[0],d.frameBody.appendChild(d.highlightBorder),d.transferArea.innerHTML='<svg class="badd-selected-highlighter badd-avoid-dd"></svg>',d.selectedHighlightBorder=d.transferArea.childNodes[0],d.frameBody.appendChild(d.selectedHighlightBorder),d.frameHtml.setAttribute("ng-app","baddEditor"),r(d.iframeDocument,"badd-editor-frame.min.css"),d.frameBody.setAttribute("badd-droppable",""),d.frameBody.setAttribute("badd-configurable","");var g=_.toArray(d.frameBody.querySelectorAll("*"));g.forEach(l),d.scope=o,e(d.frameHtml)(o)}},d.changePageTitle=function(e){d.pageTitle.textContent=e},d.startDragging=function(e){e.dataTransfer.setData("text","firefox needs data"),""===e.target.getAttribute("badd-configurable")?(d.previewElement=e.target,d.hideSelectedHighlightBorder()):(d.transferArea.innerHTML=e.target.getAttribute("data-element"),d.previewElement=d.transferArea.querySelector("*"))},d.stopDragging=function(e){d.transferArea.innerHTML="",d.previewElement&&d.previewElement.parentNode&&(d.previewElement.parentNode.removeChild(d.previewElement),d.previewElement=null),d.hideHighlightBorder()},d.elementEntering=function(e){d.previewElement.classList.remove("badd-hidden-preview-element"),e.stopPropagation(),e.preventDefault()},d.elementLeaving=function(e){var t=d.document.elementFromPoint(e.clientX+d.iframePosition.left,e.clientY+d.iframePosition.top);null!=t&&"IFRAME"===t.tagName&&_.contains(t.classList,"badd-editor-browser")||(d.previewElement.classList.add("badd-hidden-preview-element"),d.hideHighlightBorder())},d.elementHovering=function(e){if(e.stopPropagation(),e.preventDefault(),e.target.getAttribute&&e.target!==d.previewElement&&""===e.target.getAttribute("badd-droppable")){var t=_.toArray(e.target.childNodes),i=null,r=null;t.forEach(function(t){if(t.getBoundingClientRect&&!_.contains(e.target.classList,"badd-avoid-dd")&&t!=d.previewElement){var l=t.getBoundingClientRect(),n={X:l.width/2+l.left,Y:l.height/2+l.top},a=n.Y;a-l.top>30&&(a=l.top+30);var o=n.X;o-l.left>30&&(o=l.left+30),e.clientY>a&&e.clientX>o||e.clientY>l.bottom||(null==i?(i=t,r=l):r.left>=l.left&&r.top>=l.top&&(i=t,r=l))}}),i?e.target.insertBefore(d.previewElement,i):e.target.appendChild(d.previewElement),d.showHighlightBorder(e.target)}},d.elementDropped=function(t){t.stopPropagation(),t.preventDefault(),l(d.previewElement),e(d.previewElement)(d.scope),d.previewElement=null},d.updateHighlightBorderPosition=function(){"block"===d.highlightBorder.style.display&&d.lastHoveredTarget&&d.showHighlightBorder(d.lastHoveredTarget)},d.showHighlightBorder=function(e){var t=e.getBoundingClientRect();d.highlightBorder.style.top=t.top-3+"px",d.highlightBorder.style.left=t.left-3+"px",d.highlightBorder.style.width=e.offsetWidth+6+"px",d.highlightBorder.style.height=e.offsetHeight+6+"px",d.highlightBorder.style.display="block",d.lastHoveredTarget=e},d.showSelectedHighlightBorder=function(e){d.lastSelectedElement=e;var t=e.getBoundingClientRect();d.selectedHighlightBorder.style.top=t.top-3+"px",d.selectedHighlightBorder.style.left=t.left-3+"px",d.selectedHighlightBorder.style.width=e.offsetWidth+6+"px",d.selectedHighlightBorder.style.height=e.offsetHeight+6+"px",d.selectedHighlightBorder.style.display="block"},d.hideSelectedHighlightBorder=function(){d.lastSelectedElement=null,d.selectedHighlightBorder.style.display="none",d.selectedHighlightBorder.style.top=0,d.selectedHighlightBorder.style.left=0,d.selectedHighlightBorder.style.width=0,d.selectedHighlightBorder.style.height=0},d.updateSelectedHighlightBorderPosition=function(){d.lastSelectedElement&&d.showSelectedHighlightBorder(d.lastSelectedElement)},d.hideHighlightBorder=function(){d.highlightBorder.style.display="none",d.highlightBorder.style.top=0,d.highlightBorder.style.left=0,d.highlightBorder.style.width=0,d.highlightBorder.style.height=0},d.mouseHovering=function(e){e.stopPropagation(),e.preventDefault(),_.contains(e.target.classList,"badd-avoid-dd")||a(e.target,d.elementBeingEdited)||d.showHighlightBorder(e.target)},d.mouseClick=function(e){if(e.preventDefault(),e.target===d.lastSelectedElement&&null==d.elementBeingEdited)return d.hideSelectedHighlightBorder(),void e.stopPropagation();if(!a(e.target,d.elementBeingEdited)&&d.elementBeingEdited!=e.target){if(e.stopPropagation(),d.elementBeingEdited&&d.elementBeingEdited!==e.target){for(var t=d.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","true"),t=t.parentNode;d.selectedHighlightBorder.setAttribute("class","badd-selected-highlighter badd-avoid-dd"),d.elementBeingEdited.removeAttribute("contentEditable"),d.elementBeingEdited=null}d.showSelectedHighlightBorder(e.target)}},d.mouseDoubleClick=function(e){if(e.stopPropagation(),e.target!==d.elementBeingEdited&&!a(e.target,d.elementBeingEdited)&&(e.preventDefault(),_.contains(d.editableTags,e.target.tagName)&&!a(e.target,d.elementBeingEdited))){d.elementBeingEdited=e.target,d.elementBeingEdited.setAttribute("draggable","false");for(var t=d.elementBeingEdited.parentNode;"BODY"!=t.tagName;)(t.getAttribute("badd-draggable")||t.getAttribute("draggable"))&&t.setAttribute("draggable","false"),t=t.parentNode;d.hideHighlightBorder(),d.showSelectedHighlightBorder(d.elementBeingEdited),d.selectedHighlightBorder.setAttribute("class","badd-selected-highlighter badd-avoid-dd badd-edition-mode"),d.elementBeingEdited.contentEditable=!0;var i=d.iframe.contentWindow.getSelection();d.iframe.contentWindow.focus(),i.collapse(d.elementBeingEdited,0),d.elementBeingEdited.focus()}},d.mouseLeaving=function(e){e.stopPropagation(),e.preventDefault(),d.hideHighlightBorder()}};r.$inject=["$compile","$document","$window"],e.service("editorService",r)}();
