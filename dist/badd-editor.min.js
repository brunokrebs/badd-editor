...
!function(){var e=function(){function e(){return t.frameDocument.all?1:0}var t=this;t.TINY={},t.frameWindow=null,t.frameDocument=null,t.textArea=null,t.ie=e();var n=[],i=-30;n.cut=[1,"Cut","a","cut",1],n.copy=[2,"Copy","a","copy",1],n.paste=[3,"Paste","a","paste",1],n.bold=[4,"Bold","a","bold"],n.italic=[5,"Italic","a","italic"],n.underline=[6,"Underline","a","underline"],n.strikethrough=[7,"Strikethrough","a","strikethrough"],n.subscript=[8,"Subscript","a","subscript"],n.superscript=[9,"Superscript","a","superscript"],n.orderedlist=[10,"Insert Ordered List","a","insertorderedlist"],n.unorderedlist=[11,"Insert Unordered List","a","insertunorderedlist"],n.outdent=[12,"Outdent","a","outdent"],n.indent=[13,"Indent","a","indent"],n.leftalign=[14,"Left Align","a","justifyleft"],n.centeralign=[15,"Center Align","a","justifycenter"],n.rightalign=[16,"Right Align","a","justifyright"],n.blockjustify=[17,"Block Justify","a","justifyfull"],n.undo=[18,"Undo","a","undo"],n.redo=[19,"Redo","a","redo"],n.image=[20,"Insert Image","i","insertimage","Enter Image URL:","http://"],n.hr=[21,"Insert Horizontal Rule","a","inserthorizontalrule"],n.link=[22,"Insert Hyperlink","i","createlink","Enter URL:","http://"],n.unlink=[23,"Remove Hyperlink","a","unlink"],n.unformat=[24,"Remove Formatting","a","removeformat"],t.createEditor=function(e,o){this.editorName=e,this.obj=o,this.xhtml=o.xhtml;var r=t.frameDocument.createElement("div"),a=t.frameDocument.createElement("div"),s=t.frameDocument.createElement("div"),l=o.controls.length,c=0;for(this.i=t.frameDocument.createElement("iframe"),this.i.frameBorder=0,this.i.width=o.width||"500",this.i.height=o.height||"250",s.className="teheader",r.className=o.cssclass||"te",r.style.maxWidth=this.i.width+"px",r.appendChild(s),c;l>c;c++){var m=o.controls[c];if("n"===m)s=t.frameDocument.createElement("div"),s.className="teheader",r.appendChild(s);else if("|"==m){var d=t.frameDocument.createElement("div");d.className=o.dividerclass||"tedivider",s.appendChild(d)}else if("font"==m){var u=t.frameDocument.createElement("select"),p=o.fonts||["Verdana","Arial","Georgia"],h=p.length,f=0;for(u.className="tefont",u.onchange=new Function(this.editorName+'.ddaction(this,"fontname")'),u.options[0]=new Option("Font",""),f;h>f;f++){var g=p[f];u.options[f+1]=new Option(g,g)}s.appendChild(u)}else if("size"==m){var u=t.frameDocument.createElement("select"),v=o.sizes||[1,2,3,4,5,6,7],y=v.length,f=0;for(u.className="tesize",u.onchange=new Function(this.editorName+'.ddaction(this,"fontsize")'),f;y>f;f++){var b=v[f];u.options[f]=new Option(b,b)}s.appendChild(u)}else if("style"==m){var u=t.frameDocument.createElement("select"),w=o.styles||[["Style",""],["Paragraph","<p>"],["Header 1","<h1>"],["Header 2","<h2>"],["Header 3","<h3>"],["Header 4","<h4>"],["Header 5","<h5>"],["Header 6","<h6>"]],y=w.length,f=0;for(u.className="testyle",u.onchange=new Function(this.editorName+'.ddaction(this,"formatblock")'),f;y>f;f++){var x=w[f];u.options[f]=new Option(x[0],x[1])}s.appendChild(u)}else if(n[m]){var D,E=t.frameDocument.createElement("div"),f=n[m],N=f[2],C=f[0]*i;E.className=o.controlclass,E.style.backgroundPosition="0px "+C+"px",E.title=f[1],D="a"===N?t.action(f[3],0,f[4]||0):'.insert("'+f[4]+'", "'+f[5]+'", "'+f[3]+'")',E.onclick=D,E.onmouseover=new Function(t.hover(E,C,1)),E.onmouseout=new Function(t.hover(E,C,0)),s.appendChild(E),t.ie&&(E.unselectable="on")}}if(t.textArea.parentNode.insertBefore(r,t.textArea),t.textArea.style.width=this.i.width+"px",a.appendChild(t.textArea),a.appendChild(this.i),r.appendChild(a),t.textArea.style.display="none",o.footer){var F=t.frameDocument.createElement("div");if(F.className=o.footerclass||"tefooter",o.toggle){var k=o.toggle,$=t.frameDocument.createElement("div");$.className=k.cssclass||"toggle",$.innerHTML=k.text||"source",$.onclick=new Function(this.editorName+".toggle(0,this);return false"),F.appendChild($)}if(o.resize){var A=o.resize,I=t.frameDocument.createElement("div");I.className=A.cssclass||"resize",I.onmousedown=new Function("event",this.editorName+".resize(event);return false"),I.onselectstart=function(){return!1},F.appendChild(I)}r.appendChild(F)}t.inlineFrameDocument=this.i.contentWindow.document,t.inlineFrameDocument.open();var z="<html><head>",H=o.bodyid?' id="'+o.bodyid+'"':"";if(z+='<link rel="stylesheet" href="tinyeditor.min.css" />',z+="</head><body"+H+">"+(o.content||t.textArea.value),z+="</body></html>",t.inlineFrameDocument.write(z),t.inlineFrameDocument.close(),t.inlineFrameDocument.designMode="on",this.d=1,this.xhtml)try{t.inlineFrameDocument.execCommand("styleWithCSS",0,0)}catch(L){try{t.inlineFrameDocument.execCommand("useCSS",0,1)}catch(L){}}},t.hover=function(e,t,n){e.style.backgroundPosition=(n?"34px ":"0px ")+t+"px"},t.action=function(e,n,i){return!i||t.ie?function(){t.inlineFrameDocument.execCommand(e,0,n||null)}:void alert("Your browser does not support this function.")},t.TINY.editor=function(){function e(e,t){}return e.prototype.print=function(){this.i.contentWindow.print()},e.prototype.ddaction=function(e,t){var n=e.selectedIndex,i=e.options[n].value;this.action(t,i)},e.prototype.insert=function(e,n,i){var o=prompt(e,n);null!=o&&""!=o&&t.inlineFrameDocument.execCommand(i,0,o)},e.prototype.setfont=function(){execCommand("formatblock",0,hType)},e.prototype.resize=function(e){this.mv&&this.freeze(),this.i.bcs=t.TINY.cursor.top(e),this.mv=new Function("event",this.editorName+".move(event)"),this.sr=new Function(this.editorName+".freeze()"),this.ie?(t.frameDocument.attachEvent("onmousemove",this.mv),t.frameDocument.attachEvent("onmouseup",this.sr)):(t.frameDocument.addEventListener("mousemove",this.mv,1),t.frameDocument.addEventListener("mouseup",this.sr,1))},e.prototype.move=function(e){var n=t.TINY.cursor.top(e);this.i.height=parseInt(this.i.height)+n-this.i.bcs,this.i.bcs=n},e.prototype.freeze=function(){this.ie?(t.frameDocument.detachEvent("onmousemove",this.mv),t.frameDocument.detachEvent("onmouseup",this.sr)):(t.frameDocument.removeEventListener("mousemove",this.mv,1),t.frameDocument.removeEventListener("mouseup",this.sr,1))},e.prototype.toggle=function(e,n){if(this.d){var i=t.inlineFrameDocument.body.innerHTML;this.xhtml&&(i=i.replace(/<span class="apple-style-span">(.*)<\/span>/gi,"$1"),i=i.replace(/ class="apple-style-span"/gi,""),i=i.replace(/<span style="">/gi,""),i=i.replace(/<br>/gi,"<br />"),i=i.replace(/<br ?\/?>$/gi,""),i=i.replace(/^<br ?\/?>/gi,""),i=i.replace(/(<img [^>]+[^\/])>/gi,"$1 />"),i=i.replace(/<b\b[^>]*>(.*?)<\/b[^>]*>/gi,"<strong>$1</strong>"),i=i.replace(/<i\b[^>]*>(.*?)<\/i[^>]*>/gi,"<em>$1</em>"),i=i.replace(/<u\b[^>]*>(.*?)<\/u[^>]*>/gi,'<span style="text-decoration:underline">$1</span>'),i=i.replace(/<(b|strong|em|i|u) style="font-weight: normal;?">(.*)<\/(b|strong|em|i|u)>/gi,"$2"),i=i.replace(/<(b|strong|em|i|u) style="(.*)">(.*)<\/(b|strong|em|i|u)>/gi,'<span style="$2"><$4>$3</$4></span>'),i=i.replace(/<span style="font-weight: normal;?">(.*)<\/span>/gi,"$1"),i=i.replace(/<span style="font-weight: bold;?">(.*)<\/span>/gi,"<strong>$1</strong>"),i=i.replace(/<span style="font-style: italic;?">(.*)<\/span>/gi,"<em>$1</em>"),i=i.replace(/<span style="font-weight: bold;?">(.*)<\/span>|<b\b[^>]*>(.*?)<\/b[^>]*>/gi,"<strong>$1</strong>")),n&&(n.innerHTML=this.obj.toggle.activetext||"wysiwyg"),t.textArea.value=i,e||(t.textArea.style.height=this.i.height+"px",this.i.style.display="none",t.textArea.style.display="block",this.d=0)}else{var i=t.textArea.value;n&&(n.innerHTML=this.obj.toggle.text||"source"),this.xhtml&&!this.ie&&(i=i.replace(/<strong>(.*)<\/strong>/gi,'<span style="font-weight: bold;">$1</span>'),i=i.replace(/<em>(.*)<\/em>/gi,'<span style="font-weight: italic;">$1</span>')),t.inlineFrameDocument.body.innerHTML=i,t.textArea.style.display="none",this.i.style.display="block",this.d=1}},e.prototype.post=function(){this.d&&this.toggle(1)},{edit:e}}(),t.TINY.cursor=function(){return{top:function(n){return e()?t.window.event.clientY+t.frameDocument.documentElement.scrollTop+t.frameDocument.body.scrollTop:n.clientY+t.window.scrollY}}}()};angular.module("baddEditor").service("tinyEditorService",e)}();