...
!function(){var e=angular.module("baddEditor"),t=function(){function e(e){e.preventDefault();var t=e.target;if(null!=t.getAttribute("badd-draggble-label"))for(;null==t.getAttribute("badd-draggable");)t=t.parentNode;null!=t.getAttribute("badd-draggable")&&(c.transferArea.innerHTML=t.getAttribute("data-element"),c.previewElement=c.transferArea.childNodes[0],c.previewElement.style.pointerEvents="none",r(e,c.previewElement.tagName))}function t(e){3!=e.which&&(e.preventDefault(),_.contains(f,e.target.tagName)&&(r(e),c.transferArea.appendChild(e.target.cloneNode(!0)),c.previewElement=c.transferArea.childNodes[0],c.previewElement.style.pointerEvents="none",c.lastDraggedElement=e.target))}function n(e){var t="fa fa-question";return _.forEach(u,function(n){n.tagName===e&&(t=n.icon)}),t}function a(e){if(e.preventDefault(),c.previewElement){c.draggableConteiner.innerHTML="",c.draggableIcon=null,c.removeElement=null,c.lastDraggedElement&&(c.lastDraggedElement.style.removeProperty("pointer-events"),c.lastDraggedElement=null);for(var t=e.target;!_.contains(p,t.tagName);)t=t.parentNode;g(t)}}function r(e,t){(c.draggableIcon||t)&&(t&&!c.draggableIcon&&(c.draggableConteiner.innerHTML='<i class="'+n(t)+'"></i>',c.draggableIcon=c.draggableConteiner.childNodes[0],c.draggableIcon.style.display="block",c.draggableIcon.style.position="fixed",c.draggableIcon.style.fontSize="30px",c.draggableIcon.style.backgroundColor="#2385DC",c.draggableIcon.style.border="1px solid #999",c.draggableIcon.style.color="#fff",c.draggableIcon.style.padding="10px",c.draggableIcon.style.zIndex=16777220),s()?(c.draggableIcon.style.left=e.screenX+20+"px",c.draggableIcon.style.top=e.screenY-120+"px"):(c.draggableIcon.style.left=e.screenX-50+"px",c.draggableIcon.style.top=e.screenY-150+"px"))}function l(){c.lastDraggedElement&&c.lastDraggedElement.style.removeProperty("pointer-events"),c.draggableConteiner.innerHTML="",c.draggableIcon=null,c.previewElement&&g(c.lastHoveredDroppable)}function i(e){if(null==c.previewElement)c.baddElementHighlighter.showHighlightBorder(e.target);else{if(c.lastDraggedElement&&"none"!=c.lastDraggedElement.style.pointerEvents)return void(c.lastDraggedElement.style.pointerEvents="none");c.baddElementHighlighter.hideHighlightBorder(),c.baddElementSelector.hideSelectedHighlightBorder(),r(e,c.previewElement.tagName),o(e)}}function o(e){e.stopPropagation(),e.preventDefault();for(var t=e.target;!_.contains(p,t.tagName);)t=t.parentNode;if(c.lastDraggedElement){var n=d(e,t);if(t==c.lastDraggedElement.parentNode&&(n==c.lastDraggedElement.nextElementSibling||n==c.lastDraggedElement))return;c.lastDraggedElement.parentNode.removeChild(c.lastDraggedElement),c.lastDraggedElement=null}if(0==m(t))return void(c.lastHoveredDroppable&&t!==c.previewElement&&c.previewElement.parentNode===c.lastHoveredDroppable&&c.lastHoveredDroppable.removeChild(c.previewElement));c.lastHoveredDroppable=t,c.baddElementHighlighter.showHighlightBorder(t);var a=d(e,t);if(a)try{t.insertBefore(c.previewElement,a)}catch(r){console.log("oi")}else t.appendChild(c.previewElement)}function d(e,t){var n=_.toArray(t.childNodes),a=null,r=null;return n.forEach(function(t){if(t.getBoundingClientRect&&t!=c.previewElement){var n=t.getBoundingClientRect(),l={X:n.width/2+n.left,Y:n.height/2+n.top},i=l.Y;i-n.top>30&&(i=n.top+30);var o=l.X;o-n.left>30&&(o=n.left+30),e.clientY>i&&e.clientX>o||e.clientY>n.bottom||(null==a?(a=t,r=n):r.left>=n.left&&r.top>=n.top&&(a=t,r=n))}}),a}function g(e){c.lastHoveredDroppable&&0==m(e)&&e!==c.previewElement&&c.previewElement.parentNode===c.lastHoveredDroppable&&c.lastHoveredDroppable.removeChild(c.previewElement),c.transferArea.innerHTML="",c.previewElement.style.removeProperty("pointer-events"),c.previewElement=null,c.lastHoveredDroppable=null}function m(e){return e.getAttribute&&c.previewElement&&e!==c.previewElement&&_.contains(p,e.tagName)?void 0:!1}function s(){return null==c.ie11&&(c.ie11=!window.ActiveXObject&&"ActiveXObject"in window),c.ie11}var c=this;c.mainWindow=null,c.baddElementHighlighter=null;var p=["DIV","BODY","P"],f=["DIV","IMG","P","BUTTON","A","H1","H2","H3","H4","H5","H6"],u=[{tagName:"DIV",icon:"fa fa-square-o"},{tagName:"IMG",icon:"fa fa-picture-o"},{tagName:"P",icon:"fa fa-align-left"},{tagName:"BUTTON",icon:"fa fa-plus-square"},{tagName:"A",icon:"fa fa-link"},{tagName:"H1",icon:"fa fa-header"},{tagName:"H2",icon:"fa fa-header"},{tagName:"H3",icon:"fa fa-header"},{tagName:"H4",icon:"fa fa-header"},{tagName:"H5",icon:"fa fa-header"},{tagName:"H6",icon:"fa fa-header"}];c.setup=function(n,o,d){null==c.mainWindow&&(c.baddElementHighlighter=o,c.baddElementSelector=d,c.mainWindow=n,c.mainDocument=c.mainWindow.document,c.mainBody=c.mainDocument.querySelector("body"),c.iframe=c.mainDocument.querySelector("iframe.badd-editor-browser"),c.iframeWindow=c.iframe.contentWindow,c.iframeDocument=c.iframeWindow.document,c.iframeBody=c.iframeDocument.querySelector("body"),c.mainWindow.addEventListener("mousedown",e),c.mainWindow.addEventListener("mouseup",a),c.mainWindow.addEventListener("mousemove",r),c.mainWindow.addEventListener("blur",l),c.iframeWindow.addEventListener("mousedown",t),c.iframeWindow.addEventListener("mouseup",a),c.iframeWindow.addEventListener("mousemove",i),c.draggableConteiner=c.mainDocument.createElement("svg"),c.draggableConteiner.className="badd-draggable-conteiner",c.mainBody.appendChild(c.draggableConteiner),c.transferArea=c.mainDocument.createElement("div"),c.transferArea.className="badd-transfer-area",c.mainBody.appendChild(c.transferArea))}};e.service("baddDragDropService",t)}();
