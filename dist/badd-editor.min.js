...
!function(){var e=angular.module("baddEditor"),t=function(){function e(e){e.preventDefault();var t=e.target;if(null!=t.getAttribute("badd-draggble-label"))for(;null==t.getAttribute("badd-draggable");)t=t.parentNode;null!=t.getAttribute("badd-draggable")&&(f.transferArea.innerHTML=t.getAttribute("data-element"),f.previewElement=f.transferArea.childNodes[0],f.previewElement.style.pointerEvents="none",r(e,f.previewElement.tagName))}function t(e){3!=e.which&&(e.preventDefault(),_.contains(p,e.target.tagName)&&(r(e),f.transferArea.appendChild(e.target.cloneNode(!0)),f.previewElement=f.transferArea.childNodes[0],f.previewElement.style.pointerEvents="none",f.lastDraggedElement=e.target))}function a(e){var t="fa fa-question";return _.forEach(c,function(a){a.tagName===e&&(t=a.icon)}),t}function n(e){if(e.preventDefault(),f.previewElement){f.draggableConteiner.innerHTML="",f.draggableIcon=null,f.removeElement=null,f.lastDraggedElement&&(f.lastDraggedElement.style.removeProperty("pointer-events"),f.lastDraggedElement=null);for(var t=e.target;!_.contains(s,t.tagName);)t=t.parentNode;g(t)}}function r(e,t){if(f.draggableIcon||t){t&&!f.draggableIcon&&(f.draggableConteiner.innerHTML='<i class="'+a(t)+'"></i>',f.draggableIcon=f.draggableConteiner.childNodes[0],f.draggableIcon.style.display="block",f.draggableIcon.style.position="fixed",f.draggableIcon.style.fontSize="30px",f.draggableIcon.style.backgroundColor="#2385DC",f.draggableIcon.style.border="1px solid #999",f.draggableIcon.style.color="#fff",f.draggableIcon.style.padding="10px",f.draggableIcon.style.zIndex=16777220);var n=0,r=0;e.target.ownerDocument==f.iframeDocument&&(n=f.iframeLeftOffset,r=f.iframeTopOffset),f.draggableIcon.style.left=e.clientX+n+"px",f.draggableIcon.style.top=e.clientY-55+r+"px"}}function l(){f.lastDraggedElement&&f.lastDraggedElement.style.removeProperty("pointer-events"),f.draggableConteiner.innerHTML="",f.draggableIcon=null,f.previewElement&&g(f.lastHoveredDroppable)}function i(e){if(null==f.previewElement)f.baddElementHighlighter.showHighlightBorder(e.target);else{if(f.lastDraggedElement&&"none"!=f.lastDraggedElement.style.pointerEvents)return void(f.lastDraggedElement.style.pointerEvents="none");f.baddElementHighlighter.hideHighlightBorder(),f.baddElementSelector.hideSelectedHighlightBorder(),r(e,f.previewElement.tagName),o(e)}}function o(e){e.stopPropagation(),e.preventDefault();for(var t=e.target;!_.contains(s,t.tagName);)t=t.parentNode;if(f.lastDraggedElement){var a=d(e,t);if(t==f.lastDraggedElement.parentNode&&(a==f.lastDraggedElement.nextElementSibling||a==f.lastDraggedElement))return;f.lastDraggedElement.parentNode.removeChild(f.lastDraggedElement),f.lastDraggedElement=null}if(0==m(t))return void(f.lastHoveredDroppable&&t!==f.previewElement&&f.previewElement.parentNode===f.lastHoveredDroppable&&f.lastHoveredDroppable.removeChild(f.previewElement));f.lastHoveredDroppable=t,f.baddElementHighlighter.showHighlightBorder(t);var n=d(e,t);if(n)try{t.insertBefore(f.previewElement,n)}catch(r){console.log("oi")}else t.appendChild(f.previewElement)}function d(e,t){var a=_.toArray(t.childNodes),n=null,r=null;return a.forEach(function(t){if(t.getBoundingClientRect&&t!=f.previewElement){var a=t.getBoundingClientRect(),l={X:a.width/2+a.left,Y:a.height/2+a.top},i=l.Y;i-a.top>30&&(i=a.top+30);var o=l.X;o-a.left>30&&(o=a.left+30),e.clientY>i&&e.clientX>o||e.clientY>a.bottom||(null==n?(n=t,r=a):r.left>=a.left&&r.top>=a.top&&(n=t,r=a))}}),n}function g(e){f.lastHoveredDroppable&&0==m(e)&&e!==f.previewElement&&f.previewElement.parentNode===f.lastHoveredDroppable&&f.lastHoveredDroppable.removeChild(f.previewElement),f.transferArea.innerHTML="",f.previewElement.style.removeProperty("pointer-events"),f.previewElement=null,f.lastHoveredDroppable=null}function m(e){return e.getAttribute&&f.previewElement&&e!==f.previewElement&&_.contains(s,e.tagName)?void 0:!1}var f=this;f.mainWindow=null,f.baddElementHighlighter=null;var s=["DIV","BODY","P"],p=["DIV","IMG","P","BUTTON","A","H1","H2","H3","H4","H5","H6"],c=[{tagName:"DIV",icon:"fa fa-square-o"},{tagName:"IMG",icon:"fa fa-picture-o"},{tagName:"P",icon:"fa fa-align-left"},{tagName:"BUTTON",icon:"fa fa-plus-square"},{tagName:"A",icon:"fa fa-link"},{tagName:"H1",icon:"fa fa-header"},{tagName:"H2",icon:"fa fa-header"},{tagName:"H3",icon:"fa fa-header"},{tagName:"H4",icon:"fa fa-header"},{tagName:"H5",icon:"fa fa-header"},{tagName:"H6",icon:"fa fa-header"}];f.setup=function(a,o,d){if(null==f.mainWindow){f.baddElementHighlighter=o,f.baddElementSelector=d,f.mainWindow=a,f.mainDocument=f.mainWindow.document,f.mainBody=f.mainDocument.querySelector("body"),f.iframe=f.mainDocument.querySelector("iframe.badd-editor-browser"),f.iframeWindow=f.iframe.contentWindow,f.iframeDocument=f.iframeWindow.document,f.iframeBody=f.iframeDocument.querySelector("body");var g=f.iframe.getBoundingClientRect(),m=a.getComputedStyle(f.iframe);f.iframeLeftOffset=g.left+parseInt(m["padding-left"]),f.iframeTopOffset=g.top+parseInt(m["padding-top"]),f.mainWindow.addEventListener("mousedown",e),f.mainWindow.addEventListener("mouseup",n),f.mainWindow.addEventListener("mousemove",r),f.mainWindow.addEventListener("blur",l),f.iframeWindow.addEventListener("mousedown",t),f.iframeWindow.addEventListener("mouseup",n),f.iframeWindow.addEventListener("mousemove",i),f.draggableConteiner=f.mainDocument.createElement("svg"),f.draggableConteiner.className="badd-draggable-conteiner",f.mainBody.appendChild(f.draggableConteiner),f.transferArea=f.mainDocument.createElement("div"),f.transferArea.className="badd-transfer-area",f.mainBody.appendChild(f.transferArea)}}};e.service("baddDragDropService",t)}();
